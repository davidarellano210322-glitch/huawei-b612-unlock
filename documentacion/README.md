...
1. 📄 **[01_ESTADO_DEL_DISPOSITIVO.md](./01_ESTADO_DEL_DISPOSITIVO.md)**  
   *Detalle técnico de hardware, firmware C110, estructura de memoria, protocolo SCRAM-SHA256 y lectura en vivo de la SIM.*

2. 🔬 **[02_ANALISIS_REVERSE_ENGINEERING.md](./02_ANALISIS_REVERSE_ENGINEERING.md)**  
...
3. 🛡️ **[03_AUDITORIA_WEBUI_Y_ENDPOINTS.md](./03_AUDITORIA_WEBUI_Y_ENDPOINTS.md)**  
...
4. 🚀 **[04_GUIAS_DE_DESBLOQUEO_VIABLES.md](./04_GUIAS_DE_DESBLOQUEO_VIABLES.md)**  
...
5. 🛠️ **[05_CATALOGO_SCRIPTS_HERRAMIENTAS.md](./05_CATALOGO_SCRIPTS_HERRAMIENTAS.md)**  
...
6. 📅 **[06_CRONOLOGIA_E_HISTORIAL_INVESTIGACION.md](./06_CRONOLOGIA_E_HISTORIAL_INVESTIGACION.md)**  
...
7. 📚 **[07_FUENTES_Y_REFERENCIAS.md](./07_FUENTES_Y_REFERENCIAS.md)**  
